...
{{< image src="img/SpeedupvsDraftTokens.jpg" alt="background" width="100%" title="Figure 1: Speedup vs. drafted tokens. Combining step-level Lookahead Reasoning (LR) with Speculative Decoding (SD) delays the onset of diminishing returns and surpasses the speedup of SD alone.">}}
